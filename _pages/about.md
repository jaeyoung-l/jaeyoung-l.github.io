...
I aim to elicit model behavior through the lens of model interpretability, that is, `Interpretability + X` (where X includes multimodality, agents, training, and alignment).
